...
<head>
    ...
    <!-- Title -->
    <title>Aplikasi CRUDv3 - IegCode</title>
...
<body class="d-flex flex-column h-100">
    ...
    <header>
        <!-- Navbar -->
        <nav class="navbar navbar-expand-lg fixed-top shadow" style="background-color:#0d6efd">
    ...
    <footer class="footer mt-auto bg-white shadow py-4">
        <div class="container-fluid px-lg-5">
            ...
            <div class="copyright text-center mb-2 mb-md-0">
                &copy; 2023 - <a href="https://ibrahimelgibran.com/" target="_blank" class="text-brand text-decoration-none" style="color:#0d6efd">IegCode</a>. All rights reserved.
            </div>
        </div>
    </footer>
