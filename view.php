...
<div class="d-grid gap-2 d-md-block bg-white rounded-4 shadow-sm p-4 mb-3">
    <!-- button entri data -->
    <button id="btn-entri" class="btn btn-primary rounded-pill py-2 px-4"style="background-color: #0d6efd; color: white;" >
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <!-- button simpan data -->
                <button id="btn-simpan" type="button" class="btn btn-primary rounded-pill py-2 px-4 me-2"style="background-color: #0d6efd; color: white;">Simpan</button>
